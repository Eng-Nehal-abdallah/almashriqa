                        ...
                        <ul>
                            ...
                            <li class="dropdown"><a href="/agreementsen"><span>Acceptable</span> <i
                                ...
                                <ul>
                                    ...
                                    <li><a href="/agreementsen">Acceptable Rules </a></li>
                            ...
                            <li class="dropdown"><a href="/labexamfacen"><span>Online Studty </span> <i
                                        class="bi bi-chevron-down"></i></a>
                                <ul>
                                    <li><a href="/labexamfacen">Term lecture table</a></li>
                                    <li><a href="/labexamfacen">Exam Table </a></li>

                                </ul>
                            </li>
                            <li><a class="nav-link scrollto " href="/facutlyresearchen"> Activity</a></li>
