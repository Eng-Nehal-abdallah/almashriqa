  ...
  <div class="bg-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush my-3">
        ...
        <a href="/dashboard5" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
          ...
          <a href="/dashboard7" class="list-group-item list-group-item-action bg-transparent second-text active"><i
...
<div class="col-md-4">
   <div class="p-3 inner3  shadow-sm d-flex justify-content-around align-items-center rounded">
    ...
    <a class="btn shadow-sm btn-dark" href="/instype">Add</a>
...
<td>
         ...
         <form method="post" action="/instype/{{ $type->id }}">
             @csrf
             @method('DELETE')
