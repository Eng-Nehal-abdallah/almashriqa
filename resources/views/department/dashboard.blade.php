  ...
  <div class="bg-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush my-3">
        ...
        <a href="/dashboard2"class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
         ...
         Faculty</a>
         <a href="/dashboard3"  class="
         list-group-item list-group-item-action bg-transparent second-text active"><i
...
<div class="p-3 inner3  shadow-sm d-flex justify-content-around align-items-center rounded">
    ...
    <a class="btn shadow-sm btn-dark" href="/insert_department">Add</a>
       ...
       <table class="table table-light section-2 ">
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <td>{{ $department->details_ar }}</td>
          <td>{{ $department->details_en }}</td>
          <td>{{ $department->color }}</td>
          <td>
          @foreach($facutlies as $f)
          @if($f->id==$department->id_facutly)
         {{ $f->name_ar }}
          @endif
          @endforeach
        </td>
          <td>   <img src="/{{ $department->image }}" width="100" height="100" alt="image"></td>


          <td><a class="btn shadow-sm btn-dark" href="/department/{{ $department->id }}/edit">edit</a></td>
