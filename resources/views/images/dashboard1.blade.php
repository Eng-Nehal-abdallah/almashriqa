 ...
 class="list-group-item list-group-item-action bg-transparent second-text active"><i
  ...
  <div id="page-content-wrapper">
   ...
   <div class=" container-fluid px-4">
    ...
    <a class="btn shadow-sm btn-dark" href="/achievement1_insert/{{ $achievement->id }}">Add</a>
      ...
      <div class="col bg-light rounded shadow-sm">
       <table class="table table-light section-2 ">
        ...
        <tbody class="text-dark">
            ...
            @if($im->id_achievement==$achievement->id)
         <tr>
          <th scope="row">#</th>
          ...
          <td> <form method="post" action="/achievement1/{{ $im->id }}">
            @csrf
            @method('DELETE')
