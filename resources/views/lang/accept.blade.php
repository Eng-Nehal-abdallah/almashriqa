...
<body dir="ltr">
                    ...
                    <nav id="navbar" class="navbar">
                        ...
                        <ul>
                            ...
                            <li class="dropdown"><a href="#"><span>Acceptable</span> <i
                                        class="bi bi-chevron-down"></i></a>
                                <ul>
                                    <li><a href="/mechineen">Registration mechanism </a></li>
    ...
    <section class="section-1">
        <div class="container">
            <div class=" my-5">
                <h1 class="heading">الشروط العامة للقبول</h1>
                <small>في الدراستين الصباحية والمسائية للعام الدراسي 2021/2020</small>
            </div>
