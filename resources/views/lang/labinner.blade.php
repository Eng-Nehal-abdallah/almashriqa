...
<body class="light text-left">
    ...
    <div class="dark-mood ">
        <i class="fas moon"></i>
        =======
        <li class="dropdown"><a href="/facutlyen"><span>Facutlies</span> <i class="bi bi-chevron-down"></i></a>
                ...
                @foreach ($Facutlies as $f)
                    <li class="dropdown"><a href="/Facutlyen/{{ $f->id }}/show"><span>
                        ...
                        @foreach ($departments as $depart)
                            @if ($depart->id_facutly == $f->id)
                                <ul>
                                    <li><a href="/departmenten/{{ $depart->id }}/show">{{ $depart->name_en }}</a>
                                    </li>
                                </ul>
                            @endif
                        @endforeach
        ...
        >>>>>>> 5c7e2f38375f12271d17e791e09ae64403ae1971
    </div>
    </div>
    </header><!-- End Header -->
    <!-- end navbar -->
