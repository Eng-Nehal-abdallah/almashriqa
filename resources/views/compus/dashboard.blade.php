        ...
        <tbody class="text-dark">
         <tr>
          ...
          <td><a class="btn shadow-sm btn-dark" href="">edit</a></td>
                ...
                <a class="btn shadow-sm btn-dark" href="/compusinsert">Add</a>
                    ...
                    <div class="row section-2 my-5">
                        ...
                        <div style="overflow-x: auto;" class="col bg-light rounded shadow-sm">
                            <table class="table table-light section-2 ">
                                ...
                                <tbody class="text-dark">
                                    @foreach ($compus as $data)
                                        <tr>
                                            <th scope="row">#</th>
                                            <td><img src="{{ $data->image }}" width="100" height="100" alt="image">
                                            </td>
                                            ...
                                            <td><a class="btn shadow-sm btn-dark"
                                                    href="/compus/{{ $data->id }}/edit">edit</a></td>
                                            <td>
                                                <form method="post" action="/compus/{{ $data->id }}">
                                                    @csrf
                                                    @method('DELETE')
