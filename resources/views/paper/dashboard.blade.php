...
<div class="col-md-4">
   <div class="p-3 inner3  shadow-sm d-flex justify-content-around align-items-center rounded">
    ...
    <a class="btn shadow-sm btn-dark" href="/paper">Add</a>
       ...
       <table class="table table-light section-2 ">
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <td><a class="btn shadow-sm btn-dark" href="/paper/{{ $data->id }}/edit">edit</a></td>
<td> <form method="post" action="/paper/{{ $data->id }}">
    @csrf
    @method('DELETE')
