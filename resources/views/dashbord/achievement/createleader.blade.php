...
<div class="container">
    ...
    {{-- ////////////////// --}}
    <form action="{{ route('achievementsleader') }}"  enctype="multipart/form-data"  method="POST" >
        @csrf

        <div class="form-row">
            <input type="text" hidden class="form-control" name='id_leader' id='id_leader' value=" {{ $leader->id  }}">
