...
<body>
    ...
    <div class="table-responsive-md">
        <a class="btn shadow-sm btn-dark" href="/achievementleaderuni/{{ $leaderuni->id }}/add">Add</a>
      ...
      <div class="col bg-light rounded shadow-sm">
       <table class="table table-light section-2 ">
        ...
        <tbody class="text-dark">
            ...
            @if($data->id_leaderuni== $leaderuni->id)
         <tr>
          <th scope="row">#</th>
   ...
   <td>   <a href="/{{ $data->pdf }}" width="100" height="100" alt="pdf"> Download</a></td>
          <td>   <img src="/{{ $data->image }}" width="100" height="100" alt="image"></td>

<td>
          @foreach($types as $f)
          @if($f->id==$data->id_types)
         {{ $f->name_ar }}
          @endif
          @endforeach
        </td>
...
<td>
         ...
         <form method="post" action="/achievementss/{{ $data->id }}">
             @csrf
             @method('DELETE')
