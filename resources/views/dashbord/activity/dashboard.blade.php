 ...
 <div class="d-flex" id="wrapper">
  ...
  <div class="bg-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush my-3">
        ...
        <a href="/dashboard5" class="list-group-item list-group-item-action bg-transparent second-text active"><i
...
<div class="col-md-4">
   <div class="p-3 inner3  shadow-sm d-flex justify-content-around align-items-center rounded">
    ...
    <a class="btn shadow-sm btn-dark" href="/activity">Add</a>
       ...
       <table class="table table-light section-2 ">
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <td>   <a href="/{{ $data->video }}" width="100" height="100" alt="pdf"> Download</td>
          <td>{{$data->name_ar }}</td>
          <td>{{$data->name_en }}</td>
        ...
        <td>
          ...
          <td><a class="btn shadow-sm btn-dark" href="/activity/{{ $data->id }}/edit">edit</a></td>
          <td><a class="btn shadow-sm btn-dark" href="/dashboard30/{{ $data->id }}">add image</a></td>
<td> <form method="post" action="/activities/{{ $data->id }}">
    @csrf
    @method('DELETE')
