...
<div class="p-3 inner3  shadow-sm d-flex justify-content-around align-items-center rounded">
    ...
    <a class="btn shadow-sm btn-dark" href="/insert_faculty">Add</a>
       ...
       <table class="table table-light section-2 ">
        <thead>
         <tr>
          ...
          <th scope="col">Message en</th>


          <th scope="col">View ar</th>
          <th scope="col">View en</th>

          <th scope="col">Goal ar</th>
          <th scope="col">Goal en</th>
          ...
          <th scope="col">leader Word ar</th>
          <th scope="col">Leader Word en</th>
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <td>{{ $facu->name_ar }}</td>
          <td>{{ $facu->name_en }}</td>
          <td>{{ $facu->message_ar }}</td>
          <td>{{ $facu->message_en }}</td>
          <td>{{ $facu->view_ar }}</td>
          <td>{{ $facu->view_en	 }}</td>
