...
<body>
 <div class="d-flex" id="wrapper">
  ...
  <div class="bg-white" id="sidebar-wrapper">
   ...
   <a href="/dashboard14" class="list-group-item list-group-item-action bg-transparent second-text active"><i
  ...
  <div id="page-content-wrapper">
   ...
   <div class=" container-fluid px-4">
    ...
    <a class="btn shadow-sm btn-dark" href="/cenetr">Add</a>
       ...
       <table class="table table-light section-2 ">
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <td><a class="btn shadow-sm btn-dark" href="/center/{{ $data->id }}/edit">edit</a></td>
<td> <form method="post" action="/center/{{ $data->id }}">
    @csrf
    @method('DELETE')
