 ...
 <div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper">
   ...
   <div class=" container-fluid px-4">
    ...
    <td><a class="btn shadow-sm btn-dark" href="/leadersocial/{{ $leader->id }}/add">Add social media</a></td>
    <!-- start seection 2 -->
    <div class="table-responsive-md">
     <div class="row section-2 my-5">
      <h3 class="text-light">After head</h3>
      <td><a class="btn shadow-sm btn-dark" href="/leader/{{ $leader->id }}/add">Add social media</a></td>
      <div class="col bg-light rounded shadow-sm">
       <table class="table table-light section-2 ">
        <thead>
         <tr>
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <form method="post" action="/socialleader/{{ $social->id }}/delete">
            ...
            @csrf
            @method('DELETE')
          <td><input type="submit" class="btn shadow-sm btn-dark" value="Delete"> </a></td>
          </form>
@endif
          @endforeach
