 ...
 <div class="d-flex" id="wrapper">
  ...
  <div class="bg-white" id="sidebar-wrapper">
   ...
   <div class="list-group list-group-flush my-3">
    ...
    <a href="/dashboard13" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
      ...
      <a href="dashboard12" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
        class="fas fa-map-marker-alt me-2"></i>الاتفاقيات الجامعه</a>
  ...
  <div id="page-content-wrapper">
   ...
   <div class=" container-fluid px-4">
    ...
    <a class="btn shadow-sm btn-dark" href="/lab">Add</a>
       ...
       <table class="table table-light section-2 ">
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <td><img src="{{ $data->images }}" width="100" height="100" alt="image"></td>
          <td>   <a href="/{{ $data->pdf }}" width="100" height="100" alt="pdf"> Download</td>
          <td>{{$data->name_ar }}</td>
          <td>{{$data->name_en }}</td>
          <td>{{$data->details_ar }}</td>
          <td>{{$data->details_en }}</td>
          <td><a class="btn shadow-sm btn-dark" href="/labs/{{ $data->id }}/edit">edit</a></td>
<td> <form method="post" action="/labs/{{ $data->id }}">
    @csrf
    @method('DELETE')
