 ...
 <div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper">
   ...
   <div class=" container-fluid px-4">
    ...
    <a class="btn shadow-sm btn-dark" href="/feesinsert">Add</a>
       ...
       <table class="table table-light section-2 ">
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <td>{{ $data->tablecode_ar }}</td>




          <td><a class="btn shadow-sm btn-dark" href="/fees/{{ $data->id }}/edit">edit</a></td>
...
<td>
         ...
         <form method="post" action="/feess/{{ $data->id }}">
             @csrf
             @method('DELETE')
