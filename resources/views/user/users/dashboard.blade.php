 ...
 <div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper">
   ...
   <div class=" container-fluid px-4">
    ...
    <a class="btn shadow-sm btn-dark" href="/user">Add</a>
       ...
       <table class="table table-light section-2 ">
        <thead>
         <tr>
          ...
          <th scope="col">رقم السري</th>
          <th scope="col"> مشفر رقم السري</th>
          <th scope="col">نوع المسجل</th>
        ...
        <tbody class="text-dark">
         ...
         <tr>
          ...
          <td><a class="btn shadow-sm btn-dark" href="/user/{{ $data->id }}/edit">edit</a></td>
